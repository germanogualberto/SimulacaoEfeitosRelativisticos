...
public class Viagem {
	...
	private static int DEZANONA = 1000000000;
...
//			"/figuras/terra.png");
	...
	private static ArrayList<CorpoCeleste> getCorposCelestes() {
		...
		//corpos.add(new CorpoCeleste(588.05, 13.06, "/figuras/europa.png"));// Europa
	...
	public static ArrayList<String> getDadosViagem(int indiceCorpo,
		...
		tempoNaNave = corpo.getDistancia() / (velocidade * ModuloFisica.C);
		...
		dados.add(tempoNaNave*DEZANONA*SEGUNDOS_A_DIA + "");// Tempo na Nave
		dados.add(tempoNaTerra*DEZANONA*SEGUNDOS_A_DIA+ "");//Tempo na Terra
		dados.add(tempoNoDestino*DEZANONA*SEGUNDOS_A_DIA + "");//Tempo no Destino
